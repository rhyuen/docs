...
You can see these inputs available in the payload object mentioned in the above code. It contains a structure as shown [here](https://github.com/zeit/integration-utils/blob/master/src/types.ts#L9). We will discuss these in this section.
