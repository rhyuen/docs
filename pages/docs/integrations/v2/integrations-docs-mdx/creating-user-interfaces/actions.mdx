...
When a user clicks a button, we send a request to the UiHook with the action. The UiHook then sends a response in the form of a string of JSX components, this is what will be rendered.
