...
By [using metadata](http://localhost:3000/docs/integrations#using-the-metadata-store), UiHook's are completely dynamic, making use of [clientState](/docs/integrations#understanding-uihooks/http-payload) to understand and deliver the correct user interface.
