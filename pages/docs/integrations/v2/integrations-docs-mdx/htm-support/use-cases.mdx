...
To help you understand the benefits of `htm` and how it differs slightly from regular JSX, we have created some examples below:
...
<Caption>
  An example of using <InlineCode>htm</InlineCode> to make it simple to share a
